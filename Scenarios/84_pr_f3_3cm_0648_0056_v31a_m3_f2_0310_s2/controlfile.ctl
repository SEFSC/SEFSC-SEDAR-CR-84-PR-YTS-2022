...
0.001	   2	    0.193	    -2.92	0.22	0	 -1	0	0	0	0	0	0	0	#_NatM_p_1_Fem_GP_1            
...
0.001	   2	    0.193	    -2.92	0.22	0	 -1	0	0	0	0	0	0	0	#_NatM_p_1_Mal_GP_1            
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn # parm_name
  3	20	7.03346	   7	  99	0	  1	0	0	0	0	0	0	0	#_SR_LN(R0)  
...
2021.1 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.7987 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
0	10	0.821168	1	999	0	1	#_InitF_seas_1_flt_1Commercial
#
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
-15	15	-6.19965	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_NCRMP(2)
...
#_SizeSelex
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
   6	48	  29.699	     29	99	0	 3	0	0	0	0	0	1	2	#_SizeSel_P_1_Commercial(1)
 -15	15	      15	     15	99	0	-1	0	0	0	0	0	0	0	#_SizeSel_P_2_Commercial(1)
  -4	12	 2.85663	3.58539	99	0	 3	0	0	0	0	0	1	2	#_SizeSel_P_3_Commercial(1)
...
-999	15	     -10	    -10	99	0	-2	0	0	0	0	0	0	0	#_SizeSel_P_5_Commercial(1)
 -15	20	      15	     15	99	0	-1	0	0	0	0	0	0	0	#_SizeSel_P_6_Commercial(1)
   6	48	 18.9673	      7	99	0	 3	0	0	0	0	0	0	0	#_SizeSel_P_1_NCRMP(2)     
 -15	15	-3.15667	     15	99	0	 1	0	0	0	0	0	0	0	#_SizeSel_P_2_NCRMP(2)     
...
-999	15	     -10	    -10	99	0	-2	0	0	0	0	0	0	0	#_SizeSel_P_5_NCRMP(2)     
 -15	20	-0.38825	     15	99	0	 1	0	0	0	0	0	0	0	#_SizeSel_P_6_NCRMP(2)     
#_AgeSelex
#_No age_selex_parm
# timevary selex parameters 
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE
 6	48	26.8216	     25	99	0	3	#_SizeSel_P_1_Commercial(1)_BLK1repl_1983
 6	48	32.3689	     25	99	0	3	#_SizeSel_P_1_Commercial(1)_BLK1repl_2004
-4	12	 3.0758	3.58539	99	0	3	#_SizeSel_P_3_Commercial(1)_BLK1repl_1983
-4	12	3.80594	3.58539	99	0	3	#_SizeSel_P_3_Commercial(1)_BLK1repl_2004
