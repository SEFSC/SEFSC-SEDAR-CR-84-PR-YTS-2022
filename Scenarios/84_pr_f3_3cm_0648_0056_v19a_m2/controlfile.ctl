...
#C file write time: 2025-07-16  14:10:31
#
...
1e-04	20	6.96968	   7	  99	0	  1	0	0	0	0	0	0	0	#_SR_LN(R0)  
...
2003.8 #_last_yr_nobias_adj_in_MPD; begin of ramp
2012.6 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2019.9 #_last_yr_fullbias_adj_in_MPD
2020.3 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.8613 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
0	10	0.11	1	999	0	1	#_InitF_seas_1_flt_1Commercial
#
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
-15	15	-6.30102	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_NCRMP(2)
...
#_SizeSelex
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
   6	46	 30.3457	     29	99	0	 3	0	0	0	0	0	0	0	#_SizeSel_P_1_Commercial(1)
 -15	15	      15	     15	99	0	-1	0	0	0	0	0	0	0	#_SizeSel_P_2_Commercial(1)
  -4	12	 3.59682	3.58539	99	0	 3	0	0	0	0	0	0	0	#_SizeSel_P_3_Commercial(1)
...
-999	15	     -10	    -10	99	0	-2	0	0	0	0	0	0	0	#_SizeSel_P_5_Commercial(1)
 -15	20	      15	     15	99	0	-1	0	0	0	0	0	0	0	#_SizeSel_P_6_Commercial(1)
   6	48	 18.5495	      7	99	0	 3	0	0	0	0	0	0	0	#_SizeSel_P_1_NCRMP(2)     
 -15	15	-0.19772	     15	99	0	 1	0	0	0	0	0	0	0	#_SizeSel_P_2_NCRMP(2)     
...
-999	15	     -10	    -10	99	0	-2	0	0	0	0	0	0	0	#_SizeSel_P_5_NCRMP(2)     
 -15	20	0.450259	     15	99	0	 1	0	0	0	0	0	0	0	#_SizeSel_P_6_NCRMP(2)     
#_AgeSelex
#_No age_selex_parm
