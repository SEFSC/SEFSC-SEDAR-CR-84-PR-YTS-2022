...
#C file write time: 2024-10-29  15:21:23
datafile.dat
controlfile.ctl
...
-1 # min yr for sdreport outputs (-1 for styr); #_1981
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1748880235
