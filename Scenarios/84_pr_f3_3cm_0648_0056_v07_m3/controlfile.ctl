...
1995.5 #_last_yr_nobias_adj_in_MPD; begin of ramp
2018.9 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2019 #_last_yr_fullbias_adj_in_MPD
2022.1 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.8282 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
#_SizeSelex
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
   6	46	     29	     29	99	0	 3	0	0	0	0	0	0	0	#_SizeSel_P_1_Commercial(1)
