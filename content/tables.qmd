...
tbl_msra <- msra_summary |>
 ...
 flextable::color(color = "red", i = ~ v08a > 1 & Metric == "F Current /\nF SPR 40%", j = "v08a") |>
 flextable::color(color = "red", i = ~ v19a > 1 & Metric == "F Current /\nF SPR 40%", j = "v19a") |>
 flextable::color(color = "red", i = ~ v28a > 1 & Metric == "F Current /\nF SPR 40%", j = "v28a") |>
 flextable::color(color = "red", i = ~ v31a > 1 & Metric == "F Current /\nF SPR 40%", j = "v31a") |>
 flextable::align(align = "center", part = "all") |>
 flextable::fontsize(size = 11, part = "all") |>
 flextable::color(color = "red", i = ~ a < 0.75 & Metric == "SSB 2022 /\nSSB SPR 40%", j = "a") |>
 flextable::color(color = "red", i = ~ v01 < 0.75 & Metric == "SSB 2022 /\nSSB SPR 40%", j = "v01") |>
 flextable::color(color = "red", i = ~ v08a < 0.75 & Metric == "SSB 2022 /\nSSB SPR 40%", j = "v08a") |>
 flextable::color(color = "red", i = ~ v19a < 0.75 & Metric == "SSB 2022 /\nSSB SPR 40%", j = "v19a") |>
 flextable::color(color = "red", i = ~ v28a < 0.75 & Metric == "SSB 2022 /\nSSB SPR 40%", j = "v28a") |>
 flextable::color(color = "red", i = ~ v31a < 0.75 & Metric == "SSB 2022 /\nSSB SPR 40%", j = "v31a") |>
 flextable::font(fontname = "Times New Roman", part = "all")
