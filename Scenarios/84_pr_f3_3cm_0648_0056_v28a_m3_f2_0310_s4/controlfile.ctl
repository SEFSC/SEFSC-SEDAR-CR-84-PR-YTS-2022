...
#C file write time: 2025-06-02  16:07:46
#
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn # parm_name
  3	20	7.48789	   7	  99	0	  1	0	0	0	0	0	0	0	#_SR_LN(R0)  
...
0	10	2.1323	1	999	0	1	#_InitF_seas_1_flt_1Commercial
#
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
-15	15	-7.23193	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_NCRMP(2)
...
#_SizeSelex
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
   6	48	 27.5537	     29	99	0	 3	0	0	0	0	0	1	2	#_SizeSel_P_1_Commercial(1)
 -15	15	      15	     15	99	0	-1	0	0	0	0	0	0	0	#_SizeSel_P_2_Commercial(1)
  -4	12	 2.51825	3.58539	99	0	 3	0	0	0	0	0	1	2	#_SizeSel_P_3_Commercial(1)
...
-999	15	     -10	    -10	99	0	-2	0	0	0	0	0	0	0	#_SizeSel_P_5_Commercial(1)
 -15	20	      15	     15	99	0	-1	0	0	0	0	0	0	0	#_SizeSel_P_6_Commercial(1)
   6	48	 17.4621	      7	99	0	 3	0	0	0	0	0	0	0	#_SizeSel_P_1_NCRMP(2)     
 -15	15	-1.46069	     15	99	0	 1	0	0	0	0	0	0	0	#_SizeSel_P_2_NCRMP(2)     
...
-999	15	     -10	    -10	99	0	-2	0	0	0	0	0	0	0	#_SizeSel_P_5_NCRMP(2)     
 -15	20	-1.56138	     15	99	0	 1	0	0	0	0	0	0	0	#_SizeSel_P_6_NCRMP(2)     
#_AgeSelex
#_No age_selex_parm
# timevary selex parameters 
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE
 6	48	25.4465	     25	99	0	3	#_SizeSel_P_1_Commercial(1)_BLK1repl_1983
 6	48	33.2776	     25	99	0	3	#_SizeSel_P_1_Commercial(1)_BLK1repl_2004
-4	12	2.85587	3.58539	99	0	3	#_SizeSel_P_3_Commercial(1)_BLK1repl_1983
-4	12	3.90139	3.58539	99	0	3	#_SizeSel_P_3_Commercial(1)_BLK1repl_2004
